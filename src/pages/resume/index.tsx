                ...
                {[['creative', 'MACIEJ'], ['fullstack', 'SKORUS'], ['developer']].map((lines, i) => (
                  <div key={i}>
                    {lines.map((text, j) => (
                      <p
                        key={text}
                        className={`text-2xl tracking-wide ${j % 2 === 0 ? 'pr-2 text-right font-unica font-light text-white' : 'pl-2 text-left font-[500] bg-raspberry text-black'}`}
                      >
                        {text}
                      </p>
                    ))}
                ...
                <div>
                  ...
                  <div className='px-2 pt-2 flex flex-wrap gap-[6px]'>
                    {resumeTechList.map((tech) => {
                      ...
                      return (
                        <div key={tech} className='flex justify-between gap-[4px] text-[9px] text-white/70'>
