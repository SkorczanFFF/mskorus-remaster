  ...
  return (
    ...
    >
      ...
      <div className='gradient-slow border-primary-blue xsm:w-[450px] my-20 mt-10 flex h-full w-full flex-col items-center gap-3 border-t-2 text-white md:my-20 md:flex-col'>
        <IoMailOpenSharp className='text-primary-blue xsm:mt-4 mt-5 text-center text-8xl duration-150 hover:cursor-pointer hover:text-white' />
        <form className='xsm:px-6 w-full px-5'>
          ...
          <div className='flex w-full flex-col gap-3'>
            ...
            <div className='relative mt-3 h-[250px] w-full min-w-[180px]'>
              <textarea
                ...
                placeholder=' '
              />
              <div className='bg-primary-blue -mt-2 h-[1px] w-full' />
          ...
          <button className='bg-primary-blue hover:text-raspberry xsm:mb-5 mb-6 mt-2 w-full py-3 text-xl tracking-[6px] text-white duration-150 hover:bg-white hover:font-[500] hover:tracking-[10px]'>
            SEND
          </button>
        </form>
      </div>
