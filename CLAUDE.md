...
| Białe strzałki między sekcjami | `Portfolio.tsx:40` ma `arrow-down white` przy górnej krawędzi | Sekcja **nad** Portfolio musi mieć białe tło (dziś `Industries` z `bg-white`). Zmiana tła = biała strzałka na kolorowym tle |
